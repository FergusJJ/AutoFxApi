...
/*
These should already be verified via user id, but need to make sure that cannot verify with your own id
and then proceed to provide a different one in params
*/
...
func HandleGetAllUserPositionWrapper(c *fiber.Ctx, pg postgres.PGPosition) error {
	...
	for _, v := range positions {
		data[v.PositionID] = v.CopyPositionID
	}
